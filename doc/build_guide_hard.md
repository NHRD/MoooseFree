...
| バッテリー端子               |  2個 |
| 電源スイッチ(トグルスイッチ) |  2個 |
| ネジ(M2x7mm) ケース用(組付け済)<br>※高さ調整用ナット付き  | 10個 |
...
LED拡散用のシリコンチップは写真のようにはめてください。とくに固定されないためそっと組み立てるor木工用ボンドで少し仮止めすると良いかもしれません。  
(※今後ケースの改良を予定)  
![](./build_guide_hard/シリコンチップ1.jpg)  
![](./build_guide_hard/シリコンチップ2.jpg)  

ケース下に置き、基板の上にミドルプレートを置き、スイッチをつけます。  
ケース上を被せ、ケースの背面(下側)からねじ止めします。  

この部分、途中壁が無くなっているので、ねじがケース内に落っこちる場合があります。  
慣れないと難しいので、まずこの箇所からねじ止めすると楽です。  
![](./build_guide_hard/ケースのねじ止め.jpg)
...
エンコーダ側の軸の公差によっては緩くなるかも。  
余っているだろうカプトンテープで調整できます。  
